      ...
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start" style="background-color: #3333ff !important; color:white !important;">
        ...
        <div>
          <a class="navbar-brand brand-logo" href="<?= $uri->site ?>">
            <img src="../images/logo-v.png" alt="Centralcreditsunion Logo" class="logo" />
          </a>
          <a class="navbar-brand brand-logo-mini" href="<?= $uri->site ?>">
            <img src="../images/logo-v.png" alt="Centralcreditsunion Logo" class="logo" style="width:200px !important; height:100px !important;" />
          </a>
        </div>
      </div>
...
/* ]]> */
          ...
          <li class="nav-item">
            <form class="search-form" action="#">
              <i class="icon-search" style="color:white !important;"></i>
              <input type="search" class="form-control" placeholder="Search Here" title="Search here">
            </form>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link count-indicator" id="notificationDropdown" href="#" data-bs-toggle="dropdown">
              <i class="icon-mail icon-lg" style="color:white !important;"></i>
            </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="notificationDropdown">
              ...
              <a class="dropdown-item preview-item py-3">
                <div class="preview-thumbnail" style="color:white !important;">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link count-indicator" id="countDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <i class="icon-bell" style=" color:white !important;"></i>
          ...
          <li class="nav-item dropdown d-none d-lg-block user-dropdown">
            <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle" src="<?= $user->picture_ref ?>" alt="Profile image"> </a>
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header text-center">
                <img class="img-md rounded-circle" src="<?= $user->picture_ref ?>" alt="Profile image" style="width:50px; height:50px;">
              ...
              <a class="dropdown-item" href="sign-out"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a>
            </div>
          </li>
        </ul>

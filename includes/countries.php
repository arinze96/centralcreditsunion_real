<option value="" selected="selected">Select Country</option>
						...
						<option value="Antigua [1268]"  >Antigua [1268]</option>
						...
						<option value="Bosnia and Herzegovina [387]"  >Bosnia &amp; Herzegovina [387]</option>
						...
						<option value="CocosKeeling Islands [61]"  >CocosKeeling Islands [61]</option>
						...
						<option value="Cuba (Guantanamo Bay) [5399]"  >Cuba (Guantanamo Bay) [5399]</option>
						...
						<option value="Ellipso (Mobile Satellite service) [17625]"  >Ellipso (Mobile Satellite service) [17625]</option>
						...
						<option value="Guantanamo Bay [5399]"  >Guantanamo Bay [5399]</option>
						<option value="Guatemala [502]"  >Guatemala [502]</option>
						<option value="Guinea Bissau [245]"  >GuineaBissau [245]</option>
						...
						<option value="Macedonia (Former Yugoslav Rep of.) [389]"  >Macedonia (Former Yugoslav Rep of.) [389]</option>
						...
						<option value="Northern Marianas Islands [1670]"  >Northern Marianas Islands [1670]</option>
						<option value="Norway [47]"  >Norway [47]</option>
						<option value="Oman [968]"  >Oman [968]</option>
						<option value="Pakistan [92]"  >Pakistan [92]</option>
						<option value="Palau [680]"  >Palau [680]</option>
						<option value="Palestinian Settlements [970]"  >Palestinian Settlements [970]</option>
						...
						<option value="St. Pierre and Miquelon [508]"  >St. Pierre &amp; Miquelon [508]</option>
						<option value="St. Vincent and Grenadines [1784]"  >St. Vincent &amp; Grenadines [1784]</option>
						...
						<option value="Somali Democratic Republic [252]"  >Somali Democratic Republic [252]</option>
						...
						<option value="Trinidad and Tobago [1868]"  >Trinidad &amp; Tobago [1868]</option>

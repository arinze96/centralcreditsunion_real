...
<body>
    ...
    <div class="hero_container">
        ...
        <style>
            /* "Mobile" Image */
            .hero_container {
                background-image: url(images/business-philosophy-600x343.original.jpg);
            }

            /* "Tablet" Image */
            @media screen and (min-width:768px) {
                .hero_container {
                    background-image: url(images/business-philosophy-768x600.original.jpg);
                }
            }
            ...
            @media screen and (min-width:1024px) {
                .hero_container {
                    background-image: url(images/business-philosophy-1800x600.original.jpg);
                }
            }
        </style>
...
<!-- Mirrored from www.benchmarkbank.com/about/business-philosophy/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Sep 2021 11:50:48 GMT -->

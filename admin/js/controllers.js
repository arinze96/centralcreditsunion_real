...
$("input.send-code[data-code]").parent().css({position:"relative"}).append(
	$("<button>").attr({type:"button"}).css({position: "absolute",right: "1px",bottom: "1px",height: "50px", border: 0,padding: "0 15px", fontWeight: "bold", borderTopRightRadius: "3px",borderBottomRightRadius: "3px",fontSize: "small", zIndex:4}).text("Send Code").click(function () {
	  let button = $(this);
